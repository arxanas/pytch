...
from .backend import compile_pygments, compile_textmate
...
@click.option(
    ...
    required=True,
    type=click.Choice(["pygments", "textmate"]),
)
def cli(input_file, output_format: OutputFormat) -> None:
    ...
    elif output_format == OutputFormat.TEXTMATE:
        sys.stdout.write(compile_textmate(schema))
